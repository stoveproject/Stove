...
namespace Stove.Threading.Timers
{
    /// <summary>
    ...
    public class StoveTimer : RunnableBase, ITransientDependency
    {
        /// <summary>
        ...
        public StoveTimer(int period, bool runOnStart = false)
            : this()
        {
            Period = period;
        ...
        public override void Start()
        {
            if (Period <= 0)
            {
                throw new StoveException("Period should be set before starting the timer!");
            }

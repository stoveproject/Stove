...
namespace Stove.Dependency
{
	public static class ResolverExtensions
	{
		...
		public static TService Resolve<TService>(this ILifetimeScope scope, object argumentAsAnonymousType)
		{
			return scope.Resolve<TService>(parameters: argumentAsAnonymousType.GetTypedResolvingParameters());
		}

		public static object Resolve(this ILifetimeScope scope, Type serviceType, object argumentAsAnonymousType)
		{
			return scope.Resolve(serviceType, parameters: argumentAsAnonymousType.GetTypedResolvingParameters());
		}

...
namespace Stove.Uow
{
    ...
    public class DefaultConnectionStringResolver : IConnectionStringResolver, ITransientDependency
    {
        ...
        public virtual string GetNameOrConnectionString(ConnectionStringResolveArgs args)
        {
            ...
            throw new StoveException("Could not find a connection string definition for the application. Set IAbpStartupConfiguration.DefaultNameOrConnectionString or add a 'Default' connection string to application .config file.");
        }
    }
}